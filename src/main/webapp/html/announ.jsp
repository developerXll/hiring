			...
			<div class="row container-fluid ui-search-box">
				<form class="form-inline">
				   <div class="form-group">
				     ...
				     <input type="text" class="form-control" id="announceSearchName" placeholder="输入查询名称">
				   </div>
				   <button type="button" class="btn btn-primary" id="announceSearchBtn">查询</button>
				   <a type="button" class="btn btn-success nav-right" href="/html/addOrUpdateAnnounce.jsp#announ">新建</a>
				</form>
			</div>
...
<!-- 				</tr> -->
			...
			<nav class="nav-right">
				...
				<ul class="pagination">
					<li class="disabled">
					  <a href="javascript:void(0);" aria-label="Previous" id="announPrcv">
						<span aria-hidden="true">上一页</span>
					  </a>
					</li>
					<li>
					  <a href="javascript:void(0);" aria-label="Next" id="announNext">
